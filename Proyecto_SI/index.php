...
?>
  ...
  <div class="container">
    ...
    <ul class="collapsible">
      <li>
        <div class="collapsible-header"><i class="material-icons">class</i>PLAN DE ESTUDIOS 1981</div>
        <div class="collapsible-body" ><span>El plan de estudios de la Licenciatura en Ingeniería en Computación
            (clave 0674) de la Universidad Nacional Autónoma de México (UNAM) se inició en 1981. Este programa tiene una
            duración de 9 semestres y requiere completar 380 créditos obligatorios y 32 créditos optativos.
            No hay límite de inscripciones por periodo y el plan de estudios no es vigente.</span><a
            href="plan1.html">Conoce los requisitos de titulacion</a></div>
      </li>
      <li>
        <div class="collapsible-header"><i class="material-icons">class</i>PLAN DE ESTUDIOS 1984</div>
        <div class="collapsible-body"><span>El plan de estudios de la Licenciatura en Ingeniería en Computación
            (clave 0080) de la Universidad Nacional Autónoma de México (UNAM) se inició en 1984. Este programa tiene una
            duración de 9 semestres y requiere completar 380 créditos obligatorios y 38 créditos optativos.
            No hay límite de inscripciones por periodo y el plan de estudios no es vigente</span><a
            href="plan1.html">Conoce los requisitos de titulacion</a></div>
      </li>
      <li>
        <div class="collapsible-header"><i class="material-icons">class</i>PLAN DE ESTUDIOS 1992</div>
        <div class="collapsible-body"><span>El plan de estudios de la Licenciatura en Ingeniería en Computación
      ...
      <li>
        <div class="collapsible-header"><i class="material-icons">class</i>PLAN DE ESTUDIOS 2008</div>
        <div class="collapsible-body"><span>El plan de estudios de la Licenciatura en Ingeniería en Computación
      ...
      <li>
        <div class="collapsible-header"><i class="material-icons">class</i>PLAN DE ESTUDIOS 2020</div>
        <div class="collapsible-body"><span>El plan de estudios de la Licenciatura en Ingeniería en Computación
